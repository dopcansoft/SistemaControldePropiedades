<?
    ...
    try{
        ...
        if(isset($db)){
    		...
    		$items = $inventarioFactory->filtrado($empresa->id, $periodo->id, "", "", "", "", "", "", "", $estatusInventario, $db, $queries, $settings, $log, "", 2);	
	...
	<div class="content-fluid">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<table style="background:#FFF !important; page-break-inside: avoid;" width="100%" class="table-fichas" class="table-fichas">
					<thead>
						<tr>
						...
						<tr>
							<th colspan="3">
								<h3 style="text-align: center; font-weight: bold;"><small>BIENES MUEBLES MENORES A 70 UMAS</small></h3>
							</th>
						</tr>
					</thead>
				</table>
							...
							<table class="table-separator-bottom table-contenido">
								...
								<tbody style="margin-bottom:0 !important; padding-bottom:0 !important;">
									...
									foreach($content["list"] as $bien){									
										...
										<tr>
											<td><?=$bien->folio?></td>
											<td><? if($bien->imagen!=""){ ?><img src="<?=$settings->prop("system.url").$bien->imagen?>" style="max-height: 75px; max-width: 75px;" width="75"><? }else{ echo "&nbsp;"; } ?></td>
