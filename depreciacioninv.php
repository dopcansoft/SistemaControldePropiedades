    ...
    try{
        ...
        if(isset($db)){
          ...
          if($clasificacion!="" || $departamento!="" || $edoFisico!=""){
            ...
            $list = $inventarioFactory->filtrado($empresa->id, $periodo->id, BienFactory::TIPO_INVENTARIO_CONTABLE, "", "", "", $clasificacion, $departamento, $edoFisico, $estatusInventario, $db, $queries, $settings, $log);
...
<html lang="en">
  ...
  <body class="nav-md body-loading">
                    ...
                    <table id="articulos" class="table table-responsive table-striped table-bordered tabla-datos">
                      <thead>
                        <tr>
                          ...
                          <th>Valor</th>
                          <th>Fecha Adquisicion/Valuacion</th>
                          <th>Depreciacion Acumulada</th>
                          <th>Depreciacion Periodo</th>
                          <th>Depreciacion Acumulada</br>(Recalculada)</th>
                          <th>Depreciacion Periodo</br>(Recalculada)</th>
                          <th>&nbsp;</th>
                        </tr>
                      </thead>
                      <tbody>
                        ...
                        if(isset($list) && count($list)>0){
                            foreach($list as $bien){
                              ...
                              <tr data-id="<?=$bien->id?>">
                                  ...
                                  <td><?=$bien->depreciacionAcumulada?></td>
                                  <td><?=$bien->depreciacionPeriodo?></td>
                                  <td>&nbsp;</td>
                                  <td>&nbsp;</td>
                                  <td>
                                      <a href="#" class="btn btn-info btn-xs btn-edicion-rapida" data-id="" data-id-empresa="" data-id-periodo=""><i class="fa fa-pencil"></i> Editar</a>
    ...
    <script src="depreciacioninv.js"></script>
  </body>
</html>