...
class LoggerPatternConverterFile extends LoggerPatternConverter {
	...
	public function convert(LoggerLoggingEvent $event) {
		//echo $event->getLocationInformation()->getFileName();
		return $this->last($event->getLocationInformation()->getFileName());
	}

	//modificado el 24/05/2017
	//@utor: MARCO ANTONIO LOZADA LOPEZ
