...
<html lang="en">
  ...
  <body class="nav-md body-loading">
                        ...
                        <tr class="dummy">
                          ...
                          <td>&nbsp;</td>
                        	...
                        	<td>
                        		...
                        		<a href="#" class="btn btn-primary btn-xs btn-fotos" data-id="" data-id-periodo=""><i class="fa fa-camera"></i> Anexo</a>
                            ...
                            foreach($list as $bien){
                              ...
                              <tr data-id="<?=$bien->id?>">
                                  ...
                                  <td>
	                                ...
	                                ?>   
                                    <a href="bien.php?id=<?=$bien->id?>&origen=BAJAS" class="btn btn-info btn-xs btn-editar" data-id="<?=$bien->id?>" data-id-periodo="<?=$periodo->id?>"><i class="fa fa-search"></i> Detalle </a>
                                    <a href="bien.php?id=<?=$bien->id?>" class="btn btn-primary btn-xs btn-fotos" data-id="<?=$bien->id?>" data-id-periodo="<?=$periodo->id?>"><i class="fa fa-camera"></i> Anexo </a>
                                  </td>
                              </tr>     
                              <? 
                            } 
    ...
    <script src="inventariobajas.js"></script>
  </body>
</html>