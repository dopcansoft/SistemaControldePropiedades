                    ...
                    <div class="row">
                    	<div class="col-md-6">
	                    	<div class="alert alert-info" role="alert">
	                    		<p><i class="fa fa-info-circle"></i> La baja de los presentes bienes es establecida por inspección física y disminuyendo los efectos debidos al deterioro Físico y a la Obsolescencia Funcional y Económica de cada bien valuado.</p>
	                    	</div>
                    	</div>
                    </div>
                    <div class="row">                    	
                    ...
                    <table id="articulos" class="table table-responsive table-striped table-bordered tabla-datos">
                      <thead>
                        <tr>
                          ...
                          <th>Folio</th><!-- 2 -->
                          <th>Descripción</th><!-- 3 -->
                          <th>Clasificación</th><!-- 4 -->
                          <th>Tipo</th><!-- 5 -->
                          <th>Departamento</th><!-- 6 -->
                          <th>Estado Fisico</th><!-- 7 -->
                          <th>Tipo Valuación</th><!-- 8 -->
                          <th>Valor</th><!-- 9 -->
                          <th>Imagen</th><!-- 10 -->
                        </tr>
                      </thead>
