                    ...
                    <table id="articulos" class="table table-responsive table-striped table-bordered tabla-datos">
                      <thead>
                        <tr>
                          ...
                          <th>Superficie Contrucción</th>
                          <th>Fecha Ultima Valuación</th>
                          <th>Valor</th>
                          <th>&nbsp;</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr class="dummy">
                        	...
                        	<td>&nbsp;</td>
                        	<td>
                        		<a href="#" class="btn btn-info btn-xs btn-editar" data-id="" data-id-empresa=""><i class="fa fa-pencil"></i> Editar</a>
                        		<a href="#" class="btn btn-danger btn-xs btn-eliminar" data-id="" data-id-empresa=""><i class="fa fa-trash"></i> Eliminar</a>
                            <a href="#" class="btn btn-primary btn-xs btn-cedula" data-id=""><i class="fa fa-book"></i> Ficha </a>
                          </td>
                        </tr>
                        <?
                        if(isset($list) && count($list)>0){
                            foreach($list as $bien){
                              ...
                              <tr data-id="<?=$bien->id?>">
                                  <td><?=$bien->folio?></td>
                                  <td><?=$bien->descr?></td>
                                  <td><?=$bien->tipo->descr?></td>
                                  <td><?=$bien->clasificacion->descr?></td>
                                  <td><?=$bien->superficieTerreno?></td>
                                  <td><?=$bien->superficieConstruccion?></td>
                                  <td><?
                                    $date = new DateTime($bien->fechaUltimoAvaluo);
                                    echo $date->format("d-m-Y h:i:s");
                                  ?></td>
                                  <td style="text-align: right !important;"><?=number_format($bien->valorCapitalizable!=""&&$bien->valorCapitalizable>0?$bien->valorCapitalizable:$bien->valor,2,".",",")?></td>
                                  <td>
                                    <? 
                                    if($misesion->perfil->id==Usuario::PERFIL_ADMIN||$misesion->perfil->id==Usuario::PERFIL_CAPTURISTA){ 
	                                    ?>
	                                    <a href="#" class="btn btn-info btn-xs btn-editar" data-id="<?=$bien->id?>"><i class="fa fa-pencil"></i> Editar</a>
	                                	  <a href="#" class="btn btn-danger btn-xs btn-eliminar" data-id="<?=$bien->id?>" ><i class="fa fa-trash"></i> Eliminar </a>
                                      <a href="#" class="btn btn-primary btn-xs btn-cedula" data-id="<?=$bien->id?>"><i class="fa fa-book"></i> Ficha </a>
                                      <?
	                                  }
	                                  ?>   
                                  </td>
