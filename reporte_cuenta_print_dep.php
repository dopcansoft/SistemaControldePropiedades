			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<table class="table-reporte-cuentas">
					<thead>
						...
						<tr>
							<td colspan="6">
								<h3 style="font-weight: bold; text-align: center;"><small>BALANZA CONTABLE CON DEPRECIACIÓN AL 31 DE DICIEMBRE DE 2019</small></h3>
							</td>
						</tr>
						<tr class="subheader">
					...
					foreach($list as $item){
						...
						<tr <?=strlen($item->cuenta)==7?'class="subheader" style="background:#DDD !important; font-weight:bold !important;"':''?>>
							...
							<td style="text-align: right;">
								<?=number_format($item->depreciacionAcumulada,2,'.',',')?>
							</td>
							<td style="text-align: right;">
