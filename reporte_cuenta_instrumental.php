...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12 my-form">
					<div class="x_panel">
						<div class="x_title">
							<h3><small>Resumen por Cuenta Contable (Instrumental)</small> <button id="btn-imprimir" class="btn btn-md btn-primary"> Imprimir <i class="fa fa-print"></i></button></h3>
						</div>
						<div class="x_content">
							<!-- CONTENIDO -->
							...
							<table class="table-reporte-cuentas">
								<thead>
									<tr class="subheader">
										<td width="55%" colspan="2">CUENTA</td>
										<td width="25%">VALOR HISTORICO</td>
                                        <td width="25%">VALOR ACTUAL/AVALUO</td>
    ...
    <script src="reporte_cuenta_instrumental.js"></script>
  </body>
</html>