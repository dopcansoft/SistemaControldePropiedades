<?
    ...
    try{
        ...
        if(isset($db)){
    		...
    		$items = $inventarioFactory->filtrado($empresa->id, $periodo->id, "", "", "", "", "", "", "", "", $db, $queries, $settings, $log, "", 3);	
...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12 my-form">
					<div class="x_panel">
						<div class="x_title">
							<h3><small>Auxiliar Especial Baja del Ejercicio</small> <button id="btn-imprimir" class="btn btn-md btn-primary"> Imprimir <i class="fa fa-print"></i></button></h3>
						</div>
						<div class="x_content">
							<!-- CONTENIDO -->
										...
										<table class="table-reporte table-margin-bottom">
											<thead>
												...
												<tr style="background:#DDD !important;">
													...
													<th width="10%">FECHA ADQUISICIÓN/AVALUO</th>
                                                    <th width="10%">ESTADO FÍSICO</th>													
                                                    <th width="10%">VALOR HISTORICO</th>
                                                    <th width="15%">VALOR ACTUAL/AVALUO</th>
												</tr>
											</thead>
											<tbody>
												<?
												...
												foreach($content["list"] as $bien){									
													?>
													<tr>
														<td width="15%" style="white-space: nowrap;"><?=$bien->folio?></td>
														<td width="10%"><? if($bien->imagen!=""){ ?><img src="<?=$settings->prop("system.url").$bien->imagen?>" width="75"><? }else{ echo "&nbsp;"; } ?></td>
														<td width="24%"><?=$bien->descripcion?></td>
														<td width="5%"><?=$bien->marca?></td>
														<td width="5%"><?=$bien->modelo?></td>
														<td width="5%"><?=$bien->serie?></td>
														<!-- <td width="5%"><?=$bien->motor?></td> -->
														<td width="5%"><?
                                                        ...
                                                        ?></td>
														<td width="5%"><i style="color:<?=$estatusColor[$bien->estadoFisico->id]?>;" class="fa fa-circle"></i>&nbsp;<?=$bien->estadoFisico->descr?></td>
    ...
    <script src="auxiliar_especial_baja_ej.js"></script>
  </body>
</html>