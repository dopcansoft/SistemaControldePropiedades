                ...
                <div class="x_panel">
					<div class="x_content">
						...
						<div class="row form-group">
							...
							<div class="col-md-4">
								<input class="form-control" type="text" name="txt-descr" id="txt-descr" value="<?=$departamento->descr?>" readonly="readonly">
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-2">
							...
							<div class="col-md-4">
								<input class="form-control" type="text" name="txt-folio" id="txt-folio" value="<?=$departamento->folio?>" placeholder="001" readonly="readonly">
							</div>
						</div>
                            ...
                            <div class="col-md-4">
                                <select class="form-control" id="sl-responsable" name="sl-responsable">
                                    ...
                                    foreach($responsables as $row){
                                        ?>
                                        <option <?=$responsable->id==$row->id?'selected="selected"':''?> value="<?=$row->id?>"><?=$row->titulo." ".$row->nombre." ".$row->apellido?></option>
                                        <?
                                    }
                                    ?>
                                </select>    
