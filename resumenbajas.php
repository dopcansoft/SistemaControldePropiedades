...
<html lang="en">
  ...
  <body class="nav-md">
        ...
        <div class="right_col" role="main">
          <div class="">
              ...
              <div class="title_left">
                ...
                <small><a href="inventario.php">Inventario</a> > <a href="#"><strong>Reporte de Bajas</strong></a></small>
              </div>
            </div>
            <div class="clearfix"></div>
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12 my-form">
					<div class="x_panel">
						<div class="x_title">
							<h3><small>Reporte de Bajas</small> <button id="btn-imprimir" class="btn btn-md btn-primary"> Imprimir <i class="fa fa-print"></i></button>&nbsp;<button id="btn-xls" class="btn btn-md btn-success"> Excel <i class="fa fa-print"></i></button></h3>
						</div>
						<div class="x_content">
							<!-- CONTENIDO -->
    ...
    <script src="resumenbajas.js"></script>
  </body>
</html>