<?
    ...
    try{
        ...
        if(isset($db)){
    		...
    		$items = $inventarioFactory->filtrado($empresa->id, $periodo->id, "UTILITARIO", "", "", "", "", "", "", $estatusInventario, $db, $queries, $settings, $log, "", 7);	
...
<html lang="en">
  ...
  <body class="nav-md">
										...
										<table class="table-reporte table-margin-bottom">
											...
											<tbody>
												...
												foreach($content["list"] as $bien){									
													?>
													<tr>
														<td width="15%" <?=$bien->notas!=""?'rowspan="2"':''?> style="white-space: nowrap;"><?=$bien->folio?></td>
														<td width="10%" <?=$bien->notas!=""?'rowspan="2"':''?>><? if($bien->imagen!=""){ ?><img src="<?=$settings->prop("system.url").$bien->imagen?>" width="75"><? }else{ echo "&nbsp;"; } ?></td>
                                                    ...
                                                    if($bien->notas!=""){
                                                        ?>
                                                        <tr>
                                                            <td style="background: #EEE;" colspan="8"><strong>OBSERVACIONES: </strong>
    ...
    <script src="auxiliar_especial_gasto_nocontable.js"></script>
  </body>
</html>