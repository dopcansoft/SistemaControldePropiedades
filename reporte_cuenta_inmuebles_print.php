			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<table class="table-reporte-cuentas">
					<thead>
						...
						<tr>
							<td colspan="6">
								<h3 style="text-align: center;"><small>BALANZA DE COMPROBACIÓN DE BIENES INMUEBLES AL 30 DE NOVIEMBRE DE 2020</small></h3>
							</td>	
						</tr>
						<tr class="subheader">
				...
				<table width="100%">
					...
					<tr>
						...
						<td colspan="2" style="text-align: center;">Tesorera Municipal</td>
