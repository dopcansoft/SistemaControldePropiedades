        ...
        <div class="right_col" role="main">
          <div class="">
              ...
              <div class="title_left">
                ...
                <small><a href="inventario.php">Inventario</a> > <a href="resguardos.php">Resguardos</a> > <a href="#"><strong>Etiquetas</strong></a></small>
              </div>
            </div>
            <div class="clearfix"></div>
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12 my-form">
					<div class="x_panel">
						<div class="x_title">
							<h3><small>Departamento: <strong><?=$departamento->descr?></strong></small> </h3>
						</div>
						<div class="x_content">
							<!-- CONTENIDO -->
                    ...
                    ?>
                    <div class="col-md-3 item-label item-label-qr">
                        <div class="row">
                            <div class="col-md-4">
                                <img src="<?=$settings->prop('system.url').$settings->prop('qrcode.path').$item->id.".png"?>">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <p class="option"><input type="checkbox" id="chk<?=$item->id?>" data-folio="<?=$item->folio?>" data-id="<?=$item->id?>" name="chk<?=$item->id?>" checked="checked"></p>
                                </div>  
                              </div>                             
                            </div>    
                        </div>
                    ...
                    ?>
  									<div class="col-md-3 item-label">
  										<p><img width="35px" src="imgs/<?=$empresa->logoEtiqueta?>"> <strong><?=$empresa->nombre?> <small>2019 - 2021<small></strong> </p>    
  										<p class="descr"><?=$item->departamento->descr?></p>
  										<p class="descr"><?=$item->getShortName(24)?></p>
  										<img class="barcode" src="src/lib/phpbarcode/barcode.php?text=<?=$item->empresa->id.';'.$item->periodo->id.';'.$item->folio?>&size=20&print=false">
  										<p class="descr" style="font-size: .9em; font-weight: bold; margin-top: 5px !important;"><?=$item->folio?></p>
  										<p class="option"><input type="checkbox" id="chk<?=$item->id?>" data-folio="<?=$item->folio?>" data-id="<?=$item->id?>" name="chk<?=$item->id?>" checked="checked"></p>
  									</div>
  									<?
                  }
