<?
    ...
    try{
        ...
        if(isset($db)){
            ...
            //$items = array_merge($items, $inmuebles);
...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12 my-form">
					<div class="x_panel">
						<div class="x_title">
							<h3><small>Balanza General por Objeto del Gasto </small> <button id="btn-imprimir" class="btn btn-md btn-primary"> Imprimir <i class="fa fa-print"></i></button></h3>
						</div>
						<div class="x_content">
							<!-- CONTENIDO -->
							...
							<table class="table-reporte-cuentas">
								<thead>
                                    <tr class="subheader">
                                        <td>CLAVE</td>
                                        <td style="text-align: left !important;">CUENTA</td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right !important;"><strong><?=number_format($grantotalAnterior,2,'.',',')?></strong></td>
    ...
    <script src="balanzares.js"></script>
  </body>
</html>