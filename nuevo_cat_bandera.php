...
<html lang="en">
  ...
  <body class="nav-md">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
					<div class="x_content">
						...
						<input type="hidden" id="id" name="id" value="<?=$bandera->id?>">
						...
						<div class="row form-group">
							...
							<div class="col-md-4">
								<input class="form-control" type="text" name="txt-status" id="txt-status" value="ACTIVO" readonly="readonly">
							</div>
						</div>
    ...
    <script src="nuevo_cat_bandera.js"></script>
  </body>
</html>