<?
    ...
    try{
        ...
        if(isset($db)){
			...
			$list = $datosCuentaFactory->filterBI($empresa->id, $periodo->id, $db, $queries, $log);
        }else{
...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12 my-form">
					<div class="x_panel">
						<div class="x_title">
							<h3><small>Resumen por Cuenta Contable (Bienes Inmuebles)</small> <button id="btn-imprimir" class="btn btn-md btn-primary"> Imprimir <i class="fa fa-print"></i></button></h3>
						</div>
						<div class="x_content">
							<!-- CONTENIDO -->
    ...
    <script src="reporte_cuenta_inmuebles.js"></script>
  </body>
</html>