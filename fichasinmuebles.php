<?
    ...
    try{
        ...
        if(isset($db)){
            ...
            $list = $inventarioFactory->groupByClasificacion($catBienesInmuebles, $list);

            $log->debug('Inmuebles: '.count($list));
        }else{
...
<html lang="en">
  ...
  <body class="nav-md">
        ...
        <div class="right_col" role="main">
          <div class="">
              ...
              <div class="title_left">
                ...
                <small><a href="inventario.php">Inmuebles</a> > <a href="#"><strong>Fichas Tecnicas</strong></a></small>
              </div>
            </div>
            <div class="clearfix"></div>
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12 my-form">
					<div class="x_panel">
						<div class="x_title">
							<h3><small>LISTADO FICHAS TECNICAS</small></h3>
						</div>
						<div class="x_content">
							<!-- CONTENIDO -->
    ...
    <script src="fichasinmuebles.js"></script>
  </body>
</html>