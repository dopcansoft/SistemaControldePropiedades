...
<html lang="en">
  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
					<div class="x_content">
						...
						<div class="row form-group">
							...
							<div class="col-md-4">
								<input class="form-control" type="text" name="txt-descr" id="txt-descr" value="<?=$bandera->descr?>">
							</div>
						</div>
						...
						<div class="row form-group">
							...
							<select class="form-control" id="sl-status" name="sl-status">
                                    <option value="ACTIVO" 
                                    <?if($bandera->status =="ACTIVO"){echo('selected="selected"'); }?>
                                    >ACTIVO</option>
                                    <option value="INACTIVO"  <?if($bandera->status =="INACTIVO"){echo('selected="selected"'); }?>
                                    >INACTIVO</option>
                                </select> 	
						...
						<div class="row form-group">
							...
							<div class="col-md-4">
								<input class="form-control" type="text" name="txt-folio" id="txt-folio" value="<?=$bandera->id?>" readonly="readonly">
							</div>
						</div>
    ...
    <script src="cat_bandera_edicion.js"></script>
  </body>
</html>