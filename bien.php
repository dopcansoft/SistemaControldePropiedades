  ...
  <body class="nav-md body-loading">
						...
						<div class="x_content">
							...
							<div class="row form-group">
								...
								<div class="col-md-6 col-xs-12">
									<label for="sl-clasificacion">Clasificación Armonizada</label>
							...
							<div class="row form-group">
								...
								<div class="col-md-3 col-xs-12">
									<label for="sl-origen">Número de Placa</label>
									<div class="input-group"> 
										<div class="input-group-btn">
							...
							<div class="row form-group">
								<div class="col-md-3 col-xs-12">
									<label for="sl-origen">Fondo de Origen de Adquisición</label>
							...
							<!-- <div class="row form-group datos-depreciacion">
								<div class="col-md-6 col-xs-12">
									<label for="sl-depreciacion" >Porcentaje de Depreciación</label>
							...
							<div class="row form-group">
								<div class="col-md-3">
									<button class="btn btn-primary btn-agregar-valor"><i class="fa fa-plus"></i> Agregar Valuación</button>
								</div>
							</div>
							<div class="row form-group">
								<div class="col-md-12">
										...
										<table class="valores table table-striped table-responsive">
											<thead>
												<tr class="headings">
													...
													<th class="column-title">Depreciación</br>Periodo</th>
													<th class="column-title">Depreciación</br>Acumulada</th>
    ...
    <div id="modal-agregar-valor" name="modal-agregar-valor" class="modal fade" tabindex="-1" role="dialog">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title">Agregar Valuación</h3>
