...
<html lang="en">
  <head>
    ...
    <link hre f="css/principal.css" rel="stylesheet">
										...
										<table class="table-reporte table-margin-bottom">
											...
											<tbody>
												...
												foreach($content["list"] as $bien){									
													?>
													<tr>
														<td><?=$bien->clasificacion->grupo.$bien->clasificacion->subgrupo.$bien->clasificacion->clase.$bien->clasificacion->subclase."-".$i?></td>
