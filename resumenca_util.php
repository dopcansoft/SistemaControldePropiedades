<?
    ...
    try{
        ...
        if(isset($db)){
    		...
    		$items = $inventarioFactory->filtrado($empresa->id, $periodo->id, BienFactory::TIPO_INVENTARIO_UTILITARIO, "", "", "", "", "", "", "", $db, $queries, $settings, $log);	
...
<html lang="en">
  ...
  <body class="nav-md">
									...
									<table class="table-reporte">
										...
										<tbody>
											...
											foreach($items as $bien){									
												?>
												<tr>
													<td><?=$cbm->grupo.$cbm->subgrupo.$cbm->clase.$cbm->subclase."-".$i?></td>
    ...
    <script src="resumenca.js"></script>
  </body>
</html>