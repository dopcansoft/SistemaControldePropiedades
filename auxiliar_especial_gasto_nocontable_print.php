<?
    ...
    try{
        ...
        if(isset($db)){
    		...
    		$items = $inventarioFactory->filtrado($empresa->id, $periodo->id, "UTILITARIO", "", "", "", "", "", "", $estatusInventario, $db, $queries, $settings, $log, "", 0);	
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<table style="background:#FFF !important; page-break-inside: avoid;" width="100%" class="table-fichas">
					<thead>
						...
						<tr>
							<th colspan="3">
								<h3 style="text-align: center; font-weight: bold;"><small>BIENES MUEBLES MENORES A 70 UMAS NO CONTABLE</small></h3>
							</th>
						</tr>
					</thead>
				</table>
