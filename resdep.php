								...
								<tbody>
									...
									if(isset($list) && count($list)>0){
										...
										foreach($list as $bien){
											?>
											<tr>
												<td <?=$bien->notas!=""?'rowspan="2"':''?> style="text-align:center !important;"><?=$bien->folioUnico?></td>
                        <td <?=$bien->notas!=""?'rowspan="2"':''?> ><?=$bien->folio?></td>
												<td <?=$bien->notas!=""?'rowspan="2"':''?> ><img src="<?=$bien->imagen?>" width="75"></td>
