...
<html lang="en">
  ...
  <body class="nav-md">
										...
										<table class="table-reporte table-margin-bottom">
											<thead>
												...
												<tr style="background:#DDD !important;">
                                                    ...
                                                    <th width="10%">DEPRECIACIÓN<br>ACUMULADA</th>
                                                </tr>
											</thead>
											<tbody>
												<?
												...
												foreach($content["list"] as $bien){									
													...
													<tr>
                                                        ...
                                                        <td width="5%" style="text-align: right;"><?=number_format($bien->depreciacionAcumulada!=""?$bien->depreciacionAcumulada:0,2,'.',',')?></td>
                                                    </tr>
													<?
													$i++;
												}
    ...
    <script src="resumencc_cont_dep.js"></script>
  </body>
</html>