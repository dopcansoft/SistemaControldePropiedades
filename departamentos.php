          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Catálogo de Departamentos <button id="btn-imprimir" class="btn btn-md btn-primary"> Imprimir <i class="fa fa-print"></i></button></h3>
              </div>
                      ...
                      <tbody>
                      	...
                      	foreach($list as $row){
                      		...
                      		<tr>
	                      		...
	                      		<td><button class="btn btn-primary btn-xs btn-editar" data-id="<?=$departamento->id?>"> <i class="fa fa-edit"></i> Editar </button></td>
	                      		<td><?=$row["bienes"]?></td>
	                      		<td><?=$responsable->titulo." ".$responsable->nombre." ".$responsable->apellido?></td>
	                      		<td><button class="btn btn-primary btn-xs btn-editar-asignacion" data-id="<?=$departamento->id?>"> <i class="fa fa-edit"></i> Editar </button></td>
	                      	</tr>
                      		<?
                      	}
                      	?>
